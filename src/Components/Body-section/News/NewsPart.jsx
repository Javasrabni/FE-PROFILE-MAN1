    ...
    return (
        <div className='w-full h-full flex flex-col gap-[16px]'>
            ...
            <div className='w-full h-[65px] flex items-center'>
                <h1 className='text-[18px] sm:text-2xl font-bold'>Berita Terbaru</h1>
            </div>
            ...
            <div className='flex flex-col gap-[32px]'>
                <section className='h-[256px] w-full flex flex-row justify-between'>
                    ...
                    <div className='bg-[var(--bg-secondary)] h-full w-full w-[464px] h-[256px] rounded-xl shrink-0' style={{ border: "1px solid var(--border)" }}>
                ...
                {/* 2 */}
                <section className='h-[256px] w-full flex flex-row'>
                    ...
                    <div className='p-[16px] flex flex-col gap-[16px]'>
                        <span className='flex flex-col gap-[4px]'>
                            <h1 className='text-base sm:text-lg font-bold line-clamp-2'>Kita berkarya kita bisa</h1>
                            <p className="text-sm sm:text-base text-[var(--text-secondary)] font-regular line-clamp-4">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex fugit quod nulla accusamus eaque, odit obcaecati illo hic omnis vero id magni blanditiis dolorum. Quaerat esse expedita facilis quam mollitia!
                            </p>
                        ...
                        <span>
                            <p className='text-sm sm:text-base text-[var(--text-secondary)] font-regular'>7 Maret 2025</p>
                        </span>
                    </div>
                ...
                <div className='w-full h-full flex items-center justify-center mt-[16px]'>
                    <button className='rounded-lg text-[var(--text-primary)] font-medium text-sm bg-[var(--warna-aksen)] px-[16px] py-[6px]'>Lihat semua</button>
